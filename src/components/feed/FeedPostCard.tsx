...
const typeIcon: Record<FeedPost["type"], IconDefinition> = {
  diskusi: faComment,
...
const typeBadgeClass: Record<FeedPost["type"], string> = {
...
export default function FeedPostCard({ post, canManage, onOpen, onEdit, onDelete, onShare }: Props) {
